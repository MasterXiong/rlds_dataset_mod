...
DATASET_TRANSFORMS=(
    ...
    "jaco_play 0.1.0 padded_resize_and_jpeg_encode"
    "berkeley_cable_routing 0.1.0 padded_resize_and_jpeg_encode"
    "roboturk 0.1.0 padded_resize_and_jpeg_encode"
    "nyu_door_opening_surprising_effectiveness 0.1.0 padded_resize_and_jpeg_encode"
    "viola 0.1.0 padded_resize_and_jpeg_encode"
    "berkeley_autolab_ur5 0.1.0 padded_resize_and_jpeg_encode,flip_wrist_image_channels"
    "toto 0.1.0 padded_resize_and_jpeg_encode"
    "language_table 0.1.0 padded_resize_and_jpeg_encode"
    "stanford_hydra_dataset_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode,flip_wrist_image_channels,flip_image_channels"
    "austin_buds_dataset_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode"
    "nyu_franka_play_dataset_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode"
    "furniture_bench_dataset_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode"
    "ucsd_kitchen_dataset_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode"
    "austin_sailor_dataset_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode"
    "austin_sirius_dataset_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode"
    "bc_z 0.1.0 padded_resize_and_jpeg_encode"
    "dlr_edan_shared_control_converted_externally_to_rlds 0.1.0 padded_resize_and_jpeg_encode"
